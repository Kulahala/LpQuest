...
- Shared XP v1 is implemented in C++: spawned encounter enemy deaths can add enemy-configured XP into a replicated GameState shared run XP pool, and a minimal local run-status HUD displays floor, run state, and shared XP for PIE validation.
