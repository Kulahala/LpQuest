...
- LPQ naming cleanup has migrated the current C++ reflected type names, Blueprint-facing API names, core Blueprint asset names, and Config paths to `LPQ`; old native names remain only as CoreRedirect compatibility for migrated content.
