...
#include "Ability/LPQDodgeInvulnerabilityGameplayEffect.h"
...
ULPQGameplayAbility_Dodge::ULPQGameplayAbility_Dodge()
{
	InstancingPolicy = EGameplayAbilityInstancingPolicy::InstancedPerActor;
	NetExecutionPolicy = EGameplayAbilityNetExecutionPolicy::LocalPredicted;
	CooldownGameplayEffectClass = ULPQDodgeCooldownGameplayEffect::StaticClass();
	DodgeInvulnerabilityGameplayEffectClass = ULPQDodgeInvulnerabilityGameplayEffect::StaticClass();
...
void ULPQGameplayAbility_Dodge::ActivateAbility(
...
void ULPQGameplayAbility_Dodge::ApplyCooldown(
	const FGameplayAbilitySpecHandle Handle,
	const FGameplayAbilityActorInfo* ActorInfo,
...
void ULPQGameplayAbility_Dodge::HandleDodgeRootMotionFinished()
{
	EndAbility(CurrentSpecHandle, CurrentActorInfo, CurrentActivationInfo, true, false);
}

FVector ULPQGameplayAbility_Dodge::ResolveDodgeDirection(const FGameplayEventData* TriggerEventData, const ALPQPlayerCharacter* PlayerCharacter) const
{
...
bool ULPQGameplayAbility_Dodge::ApplyPredictedDodgeMovement(ALPQPlayerCharacter* PlayerCharacter, const FVector& DodgeDirection)
{
	if (!PlayerCharacter)
	{
		return false;
	...
	DodgeRootMotionTask->OnFinish.AddDynamic(this, &ULPQGameplayAbility_Dodge::HandleDodgeRootMotionFinished);
