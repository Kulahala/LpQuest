...
UTunicGameplayAbility_EnemyMeleeAttack::UTunicGameplayAbility_EnemyMeleeAttack()
{
	InstancingPolicy = EGameplayAbilityInstancingPolicy::InstancedPerActor;
	NetExecutionPolicy = EGameplayAbilityNetExecutionPolicy::ServerOnly;
	CooldownGameplayEffectClass = UTunicEnemyMeleeAttackCooldownGameplayEffect::StaticClass();
...
void UTunicGameplayAbility_EnemyMeleeAttack::ActivateAbility(
	...
	const FGameplayEventData* TriggerEventData)
{
	...
	ATunicEnemyCharacter* EnemyCharacter = ActorInfo ? Cast<ATunicEnemyCharacter>(ActorInfo->AvatarActor.Get()) : nullptr;
	if (EnemyCharacter)
	{
