...
#include "LPQAttributeSet.generated.h"
...
class LPQUEST_API ULPQAttributeSet : public UAttributeSet
{
	GENERATED_BODY()
...
public:
	...
	ATTRIBUTE_ACCESSORS(ULPQAttributeSet, ElementalPower)
