...
#include "LPQEnemySpawnSource.generated.h"
...
class LPQUEST_API ALPQEnemySpawnSource : public AActor
{
	GENERATED_BODY()

public:
	ALPQEnemySpawnSource();
...
protected:
	...
	TSubclassOf<ALPQEnemyCharacter> EnemyClass;
...
private:
	UPROPERTY(Transient)
	TArray<TWeakObjectPtr<ALPQEnemyCharacter>> SpawnedEnemies;
};

UCLASS(Blueprintable)
class LPQUEST_API ALPQFloorWaveEnemySpawnSource : public ALPQEnemySpawnSource
{
	GENERATED_BODY()
