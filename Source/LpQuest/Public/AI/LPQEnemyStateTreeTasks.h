...
#include "LPQEnemyStateTreeTasks.generated.h"

class AAIController;
class AActor;
class ALPQEnemyAIController;
struct FStateTreeLinker;

USTRUCT(BlueprintType)
struct LPQUEST_API FLPQStateTreeGetCurrentEnemyTargetTaskInstanceData
{
	GENERATED_BODY()
...
struct LPQUEST_API FLPQStateTreeGetCurrentEnemyTargetTask : public FStateTreeAITaskBase
{
	GENERATED_BODY()

	using FInstanceDataType = FLPQStateTreeGetCurrentEnemyTargetTaskInstanceData;
...
USTRUCT(BlueprintType)
struct LPQUEST_API FLPQStateTreeGetCurrentPatrolLocationTaskInstanceData
{
	GENERATED_BODY()
...
struct LPQUEST_API FLPQStateTreeGetCurrentPatrolLocationTask : public FStateTreeAITaskBase
{
	GENERATED_BODY()

	using FInstanceDataType = FLPQStateTreeGetCurrentPatrolLocationTaskInstanceData;
...
USTRUCT(BlueprintType)
struct LPQUEST_API FLPQStateTreeGetEnemyHomeLocationTaskInstanceData
{
	GENERATED_BODY()
...
struct LPQUEST_API FLPQStateTreeGetEnemyHomeLocationTask : public FStateTreeAITaskBase
{
	GENERATED_BODY()

	using FInstanceDataType = FLPQStateTreeGetEnemyHomeLocationTaskInstanceData;
...
USTRUCT(BlueprintType)
struct LPQUEST_API FLPQStateTreeGetLastKnownTargetLocationTaskInstanceData
{
	GENERATED_BODY()
...
struct LPQUEST_API FLPQStateTreeGetLastKnownTargetLocationTask : public FStateTreeAITaskBase
{
	GENERATED_BODY()

	using FInstanceDataType = FLPQStateTreeGetLastKnownTargetLocationTaskInstanceData;
...
USTRUCT(BlueprintType)
struct LPQUEST_API FLPQStateTreeGetInvestigationDurationTaskInstanceData
{
	GENERATED_BODY()
...
struct LPQUEST_API FLPQStateTreeGetInvestigationDurationTask : public FStateTreeAITaskBase
{
	GENERATED_BODY()

	using FInstanceDataType = FLPQStateTreeGetInvestigationDurationTaskInstanceData;
...
USTRUCT(BlueprintType)
struct LPQUEST_API FLPQStateTreeGetCurrentPatrolStopTaskInstanceData
{
	GENERATED_BODY()
...
struct LPQUEST_API FLPQStateTreeGetCurrentPatrolStopTask : public FStateTreeAITaskBase
{
	GENERATED_BODY()

	using FInstanceDataType = FLPQStateTreeGetCurrentPatrolStopTaskInstanceData;
...
USTRUCT()
struct LPQUEST_API FLPQStateTreeClearLastKnownTargetLocationTaskInstanceData
{
	GENERATED_BODY()
};
...
struct LPQUEST_API FLPQStateTreeClearLastKnownTargetLocationTask : public FStateTreeAITaskBase
{
	GENERATED_BODY()

	using FInstanceDataType = FLPQStateTreeClearLastKnownTargetLocationTaskInstanceData;
...
USTRUCT()
struct LPQUEST_API FLPQStateTreeAdvancePatrolTargetTaskInstanceData
{
	GENERATED_BODY()
};
...
struct LPQUEST_API FLPQStateTreeAdvancePatrolTargetTask : public FStateTreeAITaskBase
{
	GENERATED_BODY()

	using FInstanceDataType = FLPQStateTreeAdvancePatrolTargetTaskInstanceData;
...
USTRUCT()
struct LPQUEST_API FLPQStateTreeTryEnemyMeleeAttackTaskInstanceData
{
	GENERATED_BODY()
};
...
struct LPQUEST_API FLPQStateTreeTryEnemyMeleeAttackTask : public FStateTreeAIActionTaskBase
{
	GENERATED_BODY()

	using FInstanceDataType = FLPQStateTreeTryEnemyMeleeAttackTaskInstanceData;
...
USTRUCT()
struct LPQUEST_API FLPQStateTreeEnemyConditionInstanceData
{
	GENERATED_BODY()
...
struct LPQUEST_API FLPQStateTreeEnemyHasCurrentTargetCondition : public FStateTreeConditionCommonBase
{
	GENERATED_BODY()

	using FInstanceDataType = FLPQStateTreeEnemyConditionInstanceData;
...
struct LPQUEST_API FLPQStateTreeEnemyTargetInAttackRangeCondition : public FStateTreeConditionCommonBase
{
	GENERATED_BODY()
...
struct LPQUEST_API FLPQStateTreeEnemyHasPatrolRouteCondition : public FStateTreeConditionCommonBase
{
	GENERATED_BODY()
...
struct LPQUEST_API FLPQStateTreeEnemyHasLastKnownTargetLocationCondition : public FStateTreeConditionCommonBase
{
	GENERATED_BODY()
...
struct LPQUEST_API FLPQStateTreeEnemyCurrentPatrolTargetIsStopCondition : public FStateTreeConditionCommonBase
{
	GENERATED_BODY()
